...
{
	out.print("<script>alert('Login first!');parent.location=parent.location;</script>");
}
%>
...
new CommDAO().insert(request,response,"pinglun",ext,true,true,""); 
   ...
   function check()
{
	if(document.form1.pinglunneirong.value==""){alert("Please write!!");document.form1.pinglunneirong.focus();return false;}
}
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#333333" style="border-collapse:collapse" class="newsline">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit5" value="Submit" onclick="return check();" />
