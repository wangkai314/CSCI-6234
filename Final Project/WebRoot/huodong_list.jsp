...
if(request.getParameter("huodongmingcheng")=="" ||request.getParameter("huodongmingcheng")==null ){}else{sql=sql+" and huodongmingcheng like '%"+request.getParameter("huodongmingcheng")+"%'";}
  ...
  <tr>
    ...
    <td width="220" align="center"><a class="btn btn-info btn-small" href="huodong_updt.jsp?id=<%=map.get("id")%>">Modify</a>  <a class="btn btn-info btn-small" href="huodong_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('Your sure£¿')">Delete</a>  </td>
  </tr>
  	<%
  }
   %>
