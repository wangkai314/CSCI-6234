...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc">  
  <tr>
    ...
    <td bgcolor='#cccccc'>Event Introduce</td>
...
if(request.getParameter("huodongmingcheng")=="" ||request.getParameter("huodongmingcheng")==null ){}else{sql=sql+" and huodongmingcheng like '%"+request.getParameter("huodongmingcheng")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><!--lianjie1--> <a class="btn btn-info btn-small" href="huodongxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">Details</a> </td>
  </tr>
  	<%
  }
   %>
