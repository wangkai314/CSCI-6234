...
<link rel="stylesheet" href="images/hsgcommon/div.css" type="text/css">
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="Find" class="btn btn-info btn-small" /> <input type="button" name="Submit2" value="Output EXCEL" class="btn btn-info btn-small" onClick="javascript:location.href='huodongxinxi_listxls.jsp';" />
</form>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc">  
  <tr>
    ...
    <td width="60" align="center" bgcolor="cccccc">Operation</td>
  </tr>
  <% 
...
if(request.getParameter("huodongmingcheng")=="" ||request.getParameter("huodongmingcheng")==null ){}else{sql=sql+" and huodongmingcheng like '%"+request.getParameter("huodongmingcheng")+"%'";}
  ...
  <tr>
    ...
    <td><%=map.get("huodongjieshao") %></td>
    <td><%=map.get("faburen") %></td>
    
	
    <td width="138" align="center"><%=map.get("addtime") %></td>
    <td width="60" align="center"><a class="btn btn-info btn-small" href='toupiaoxinxi_add.jsp?id=<%=map.get("id")%>'>Start Vote</a> <a class="btn btn-info btn-small" href="huodongxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">Detail</a> </td>
  </tr>
  	<%
  }
   %>
