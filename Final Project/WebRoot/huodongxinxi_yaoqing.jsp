...
if(request.getParameter("huodongmingcheng")=="" ||request.getParameter("huodongmingcheng")==null ){}else{sql=sql+" and huodongmingcheng like '%"+request.getParameter("huodongmingcheng")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a class="btn btn-info btn-small" href='yaoqing_add.jsp?id=<%=map.get("id")%>'>Invite</a> <a class="btn btn-info btn-small" href="huodongxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">Detail</a> </td>
  </tr>
  	<%
  }
   %>
