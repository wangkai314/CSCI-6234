...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
 ...
 new CommDAO().delete(request,"shoucangjilu"); 
    ...
    <td width="75" align="center"><a href="shoucangjilu_list2.jsp?scid=<%=map.get("id")%>" onclick="return confirm('You sure？')" >删除</a>
	<%
	if (map.get("biao").equals("xinwentongzhi"))
	{
	%>
	 <a href="gg_detail.jsp?id=<%=map.get("xwid")%>" target="_blank">详细</a>
	 <%
	}
	else
	{
