...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc" >  
  <tr>
    ...
    <td bgcolor='#cccccc'>Invitee Name</td>
    <td bgcolor='#cccccc' width='80' align='center'>Accept?</td>
    <td width="138" align="center" bgcolor="cccccc">Added Time</td>
    <td width="220" align="center" bgcolor="cccccc">Operation</td>
  </tr>
 <% 
    ...
    String url = "yaoqing_list2.jsp?1=1"; 
    String sql =  "select * from yaoqing where faburen='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("huodongmingcheng")=="" ||request.getParameter("huodongmingcheng")==null ){}else{sql=sql+" and huodongmingcheng like '%"+request.getParameter("huodongmingcheng")+"%'";}
 ...
 <td width='80' align='center'><%=map.get("issh").equals("ÊÇ") ? "Yes" : "No"%></td>
    <td width="138" align="center"><%=map.get("addtime") %></td>
    <td width="220" align="center"><a class="btn btn-info btn-small" href="yaoqing_updt.jsp?id=<%=map.get("id")%>">Modify</a>  <a class="btn btn-info btn-small" href="yaoqing_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('You sure£¿')">Delete</a>  </td>
  </tr>
  	<%
  }
   %>
