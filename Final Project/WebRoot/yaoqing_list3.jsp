...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc" >  
  ...
  <% 
    ...
    String sql =  "select * from yaoqing where  yaoqingzhanghao='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("huodongmingcheng")=="" ||request.getParameter("huodongmingcheng")==null ){}else{sql=sql+" and huodongmingcheng like '%"+request.getParameter("huodongmingcheng")+"%'";}
  ...
  <tr>
    ...
    <td align='center'><a class="btn btn-info btn-small" href="sh00.jsp?id=<%=map.get("id")%>&yuan=<%=map.get("issh")%>&tablename=yaoqing" onClick="return confirm('You Sure£¿')"><%=map.get("issh").equals("ÊÇ") ? "Yes" : "No"%></a></td>
  </tr>
  	<%
  }
   %>
