...
%>
  ...
  <br><br>
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" style="border-collapse:collapse">  
     ...
     <tr><td>Username£º</td><td><input name='faburen' type='text' id='faburen' value='<%= mmm.get("faburen")%>' class="form-control" /></td></tr>
     <tr><td>Invitee Name£º</td><td><input name='yaoqingzhanghao' type='text' id='yaoqingzhanghao' value='<%= mmm.get("yaoqingzhanghao")%>' class="form-control" /></td></tr>
    <tr>
      <td>&nbsp;</td>
