...
if(request.getParameter("wangzhi")=="" ||request.getParameter("wangzhi")==null ){}else{sql=sql+" and wangzhi like '%"+request.getParameter("wangzhi")+"%'";}
  ...
  <tr>
    ...
    <td width="220" align="center"><a class="btn btn-info btn-small" href="youqinglianjie_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a class="btn btn-info btn-small" href="youqinglianjie_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('You sure？')">删除</a>  </td>
  </tr>
  	<%
  }
   %>
